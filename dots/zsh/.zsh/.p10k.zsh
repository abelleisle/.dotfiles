# Generated by Powerlevel10k configuration wizard on 2025-11-25 at 14:34 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    docker_container        # docker container indicator (custom, passion-style)
    darwin_rosetta          # macOS rosetta indicator
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VICMD_CONTENT_EXPANSION='%B%F{red}❰%F{yellow}❰%F{green}❰%b'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_CONTENT_EXPANSION='%B%F{red}❰❰❰%b'
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIVIS_CONTENT_EXPANSION='%B%F{red}V%F{yellow}I%F{green}S%b'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_CONTENT_EXPANSION='%B%F{red}VIS%b'
  # Prompt symbol in overwrite vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIOWR_CONTENT_EXPANSION='%B%F{red}▶%F{yellow}▶%F{green}▶%b'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIOWR_CONTENT_EXPANSION='%B%F{red}▶▶▶%b'
  ...
  # Passion-style: wrap directory in brackets
  ...
  #[ nix_shell: nix shell (https://nixos.org/nixos/nix-pills/developing-with-nix-shell.html) ]##
  # Nix shell color (blue like passion theme).
  typeset -g POWERLEVEL9K_NIX_SHELL_FOREGROUND=blue

  # Display the icon of nix_shell if PATH contains a subdirectory of /nix/store.
  # typeset -g POWERLEVEL9K_NIX_SHELL_INFER_FROM_PATH=false

  # Passion-style: show [nix] instead of icon + pure/impure
  ...
  # Context color in SSH without privileges (yellow like passion theme).
  ...
  # Passion-style: show [SSH] for remote sessions
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_CONTENT_EXPANSION='[SSH]'
  # Custom prefix.
  # typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%fwith '

  ###[ virtualenv: python virtual environment (https://docs.python.org/3/library/venv.html) ]###
  # Python virtual environment color (green like passion theme).
  ...
  # Passion-style: show [python] instead of icon + venv name
  typeset -g POWERLEVEL9K_VIRTUALENV_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_VIRTUALENV_CONTENT_EXPANSION='[python]'
  ...
  function prompt_darwin_rosetta() {
    ...
    if [[ "$OSTYPE" == "darwin"* ]]; then
        ...
        if [[ "${cpu_info[@]:0:7}" = "Apple M" ]] && [[ "$arch_name" != "arm64" ]]; then
            p10k segment -f red -t '[ROSETTA]'
        fi
    fi
  }
  # For instant prompt support
  function instant_prompt_darwin_rosetta() {
    prompt_darwin_rosetta
  }
