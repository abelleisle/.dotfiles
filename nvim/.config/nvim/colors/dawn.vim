...
" Vim editor colors
call <sid>hi("Normal",        s:gui05, s:gui00, "", "none", "", "")
...
call <sid>hi("LineNr",        s:gui03, s:gui00, s:cterm08, "", "", "")
...
call <sid>hi("TeritaryBlock",  s:gui0B, s:gui01, s:cterm04, "", "none", "")
...
call <sid>hi("Operator",     s:gui05, "", s:cterm0A, "", "none", "")
